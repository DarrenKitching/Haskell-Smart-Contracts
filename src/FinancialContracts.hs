...
createFunction name Withdraw All UserBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Nothing) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [VarDec $ userAmount, decrementUserAmount, transferUserAmount])
createFunction name Withdraw SpecificAmount UserBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParameterList [(uint, "amount")]) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [requireSufficientBalance, decrementBalance, transferWithdrawal])
createFunction name Withdraw All ContractBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Nothing) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [transferContractBalance, contractBalanceAssignment])
createFunction name Withdraw SpecificAmount ContractBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParameterList [(uint, "amount")]) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [requireSufficientContractBalance, transferWithdrawal, decrementContractBalance])
createFunction name Deposit All UserBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Nothing) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [depositUserShare])
createFunction name Deposit SpecificAmount UserBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParameterList [(uint, "amount")]) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [(expressionToStatement $ ExpressionArgs (createIdentifierExpression "require") (CallArgumentExpr (Equality (createIdentifierExpression "msg.value") (createIdentifierExpression "amount")) [])), depositUserShare])
createFunction name Deposit All ContractBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Nothing) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [incrementContractBalance])
createFunction name Deposit SpecificAmount ContractBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParameterList [(uint, "amount")]) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [(expressionToStatement $ ExpressionArgs (createIdentifierExpression "require") (CallArgumentExpr (Equality (createIdentifierExpression "msg.value") (createIdentifierExpression "amount")) [])), incrementContractBalance])
createFunction name Transfer All ContractBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just sendParams) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [(expressionToStatement $ (PlusEquals (Index (createIdentifierExpression "balance") (createIdentifierExpression "_to")) (createIdentifierExpression "contractBalance"))), contractBalanceAssignment])
createFunction name Transfer SpecificAmount ContractBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParameterList [(addressPayable, "_to"), (uint, "amount")]) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [requireSufficientContractBalance, decrementContractBalance, expressionToStatement $ (PlusEquals (Index (createIdentifierExpression "balance") (createIdentifierExpression "_to")) (createIdentifierExpression "amount"))])
createFunction name Transfer All UserBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just sendParams) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [VarDec $ userAmount, decrementUserAmount, (expressionToStatement $ (PlusEquals (Index (createIdentifierExpression "balance") (createIdentifierExpression "_to")) (createIdentifierExpression "amount")))])
createFunction name Transfer SpecificAmount UserBalance = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParameterList [(addressPayable, "_to"), (uint, "amount")]) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Just $ createBlock [requireSufficientBalance, decrementBalance, (expressionToStatement $ PlusEquals (Index (createIdentifierExpression "balance") (createIdentifierExpression "_to")) (createIdentifierExpression "amount"))])
createFunction name BlankPayable _ _ = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Nothing) [VisibilityModifier PublicVisibility, StateMutabilityModifier PayableMutability] (Nothing) (Nothing)
...
ifValueGreaterThan (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (GreaterThan (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ block) (Nothing)))])))
ifValueGreaterThan (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (GreaterThan (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ createBlock []) (Nothing)))])))

ifValueLessThan :: Variable -> Variable -> ContractBodyElement -> ContractBodyElement
ifValueLessThan (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (LessThan (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ block) (Nothing)))])))
ifValueLessThan (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (LessThan (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ createBlock []) (Nothing)))])))

ifValueGreaterThanEqualTo :: Variable -> Variable -> ContractBodyElement -> ContractBodyElement
ifValueGreaterThanEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (GreaterThanEQualTo (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ block) (Nothing)))])))
ifValueGreaterThanEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (GreaterThanEQualTo (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ createBlock []) (Nothing)))])))

ifValueLessThanEqualTo :: Variable -> Variable -> ContractBodyElement -> ContractBodyElement
ifValueLessThanEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (LessthanEqualTo (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ block) (Nothing)))])))
ifValueLessThanEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (LessthanEqualTo (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ createBlock []) (Nothing)))])))

ifEqualTo :: Variable -> Variable -> ContractBodyElement -> ContractBodyElement
ifEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (Equality (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ block) (Nothing)))])))
ifEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (Equality (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ createBlock []) (Nothing)))])))

ifNotEqualTo :: Variable -> Variable -> ContractBodyElement -> ContractBodyElement
ifNotEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (InEquality (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ block) (Nothing)))])))
ifNotEqualTo (var1) (var2) (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [(If (IfStatement (InEquality (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))) (BlockStatement $ createBlock []) (Nothing)))])))

addRequirement :: ContractBodyElement -> Statement -> ContractBodyElement
addRequirement (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) statement = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (addStatementToBlock block statement)))
addRequirement (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) statement = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (createBlock [statement])))
...
loop x (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Just block))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (addBlockToLoop (createLoop x) (block))))
loop x (FunctionElem (FunctionDefinition name (params) modifiers (Nothing) (Nothing))) = (FunctionElem $ FunctionDefinition name (params) modifiers (Nothing) (Just (addBlockToLoop (createLoop x) (createBlock []))))
...
giveOwnership name = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParameterList [(addressPayable, "newOwner")]) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [requireOwner, (expressionToStatement $ Equals (createIdentifierExpression "owner") (createIdentifierExpression "newOwner"))])

getBalance :: String -> ContractBodyElement
getBalance name = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Nothing) [VisibilityModifier PublicVisibility, StateMutabilityModifier View] (Just $ ParameterList (ElementaryType uint) (Nothing) (Nothing) (Nothing)) (Just $ createBlock [(Return (ReturnStatement (Just ((Index (createIdentifierExpression "balance") (createIdentifierExpression "msg.sender"))))))])

getVariable :: String -> Variable -> ContractBodyElement
getVariable functionName (variable) = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier functionName)) (Nothing) [VisibilityModifier PublicVisibility, StateMutabilityModifier View] (Just $ ParameterList (getType variable) (Nothing) (Nothing) (Nothing)) (Just $ createBlock [(Return (ReturnStatement (Just (createIdentifierExpression (getVariableName variable)))))])

updateElement :: String -> Variable -> Variable -> [Variable] -> ContractBodyElement
updateElement name var1 var2 [] = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Nothing) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [expressionToStatement $ Equals (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))])
updateElement name var1 var2 params = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier name)) (Just $ createParamsFromVariables params) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [expressionToStatement $ Equals (createIdentifierExpression (getVariableName var1)) (createIdentifierExpression (getVariableName var2))])

becomeRecipient :: String -> Recipient -> ContractBodyElement
becomeRecipient functionName (Recipient name) = FunctionElem $ FunctionDefinition (IdentifierName (createIdentifier (functionName))) (Nothing) [VisibilityModifier PublicVisibility] (Nothing) (Just $ createBlock [(expressionToStatement $ Equals (createIdentifierExpression name) (createIdentifierExpression "msg.sender"))])
...
join newName (FunctionElem (FunctionDefinition name1 (params1) modifiers1 (Nothing) (Just block1))) (FunctionElem (FunctionDefinition name2 (params2) modifiers2 (Nothing) (Just block2))) = (FunctionElem (FunctionDefinition (IdentifierName $ createIdentifier newName) (joinParamLists params1 params2) (removeDuplicateVisibility $ joinModifiers modifiers1 modifiers2) (Nothing) (Just (joinBlocks block1 block2))))
join newName (FunctionElem (FunctionDefinition name1 (params1) modifiers1 (Nothing) (Nothing))) (FunctionElem (FunctionDefinition name2 (params2) modifiers2 (Nothing) (Nothing))) = (FunctionElem (FunctionDefinition (IdentifierName $ createIdentifier newName) (joinParamLists params1 params2) (removeDuplicateVisibility $ joinModifiers modifiers1 modifiers2) (Nothing) (Nothing)))
join newName (FunctionElem (FunctionDefinition name1 (params1) modifiers1 (Nothing) (Just block1))) (FunctionElem (FunctionDefinition name2 (params2) modifiers2 (Nothing) (Nothing))) = (FunctionElem (FunctionDefinition (IdentifierName $ createIdentifier newName) (joinParamLists params1 params2) (removeDuplicateVisibility $ joinModifiers modifiers1 modifiers2) (Nothing) (Just (block1))))
join newName (FunctionElem (FunctionDefinition name1 (params1) modifiers1 (Nothing) (Nothing))) (FunctionElem (FunctionDefinition name2 (params2) modifiers2 (Nothing) (Just block2))) = (FunctionElem (FunctionDefinition (IdentifierName $ createIdentifier newName) (joinParamLists params1 params2) (removeDuplicateVisibility $ joinModifiers modifiers1 modifiers2) (Nothing) (Just (block2))))

...
contract Ballot {
	...
	function delegate(address to) public {
		...
		if (delegate_.voted) proposals[delegate_.vote].voteCount += sender.weight; else proposals[delegate_.vote].voteCount += sender.weight; 
	}
	function vote() public returns (uint proposal){
		Voter storage sender = voters[msg.sender];
